...
class Apartment {
	class Assemble {
		...
		public String toString() {
			return "Assemble [bricks=" + bricks + ", cement=" + cement + ", sand=" + sand + ", iron=" + iron
					+ ", interiors=" + interiors + "]";
		}
	...
	public Apartment(BuildApartment buildapp) {
		assemble = new Assemble(buildapp.bricks, buildapp.cement, buildapp.sand, buildapp.iron, buildapp.interiors);
		company = "prestige Apartments";
	}

	@Override
	public String toString() {
		return "Apartment [a=" + assemble + ", company=" + company + "]";
	}
